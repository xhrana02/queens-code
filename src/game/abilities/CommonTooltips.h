...
#define REGENERATION_TOOLTIP "<br><i>Each unit Regenerates at the start of its owner's turn, regaining 3 EN .</i>"
#define REST_TOOLTIP "<br><i>Units that have not taken any action during the turn Rest, regaining 1 HP and 3 EN.</i>"
...
#define HP_DAMAGE_TOOLTIP "<br><i>HP damage directly reduces target's HP. This is the most powerful form of damage.</i>"
...
#define ARMOR_TOOLTIP "<br><i>Units with Armor take 1 damage less for each point of Armor.</i>"
